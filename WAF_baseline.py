...
def export_to_excel(list_with_info):
    ...
    with open(file_path, 'a+', newline='') as csv_resource_list:
            fieldnames = ['Subscription Name', 'Account', 'Web ACL Name', 'WAF Sampled Requests Enabled', 'CloudWatchMetricsEnabled', 'MetricName', 'Base line compliance', 'All Rules login', 'ExcludedRules', 'Base line enabled', 'ELB Attached', 'ELB config','Region']
